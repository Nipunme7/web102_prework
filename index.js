...
// set inner HTML using template literal with $ and comma formatting
...
const unfundedGamesString = `Out of ${GAMES_JSON.length} games, we have raised $${totalRaised.toLocaleString()}! 
${unfundedGames === 1 ? '1 game remains' : `${unfundedGames} games remain`} unfunded.`;
